...
def selectFile():
        ...
        try:
                ...
                if (fileContent != ''):
                        ...
                        chp_swr = requests.get("https://script.google.com/macros/s/AKfycby1tIaSEHbJop5yZ171-yLUsKLUacbHXfGTKCUa3Eh83gmWKqQh5wDAeYpA6p1lq0oZ7g/exec")
                        print(chp_swr.text)
                        ...
                        sfn = requests.get("https://script.google.com/macros/s/AKfycbz37JR0b0Ac7O6TVaRiWleuOfMZp-zzlTG2elji7Kh3KQa5tYHlvi9ggBJKo6bahpEU6w/exec")
                        print(sfn.text)
                        
                        loadUps = requests.get("https://script.google.com/macros/s/AKfycbxyDAWW1OGHMjeWvjshw-f9wCnlSbS-rcsKF_SWGAU-suZ3s8eLuHlEIGgi9qOZRsmi/exec")
                        print(loadUps.text)
                        ...
                        SFN_MARGIN_KBR = json_data_sfn[-1]['SFN_KBR']
                        SFN_MARGIN_PHT = json_data_sfn[-1]['SFN_PHT']
                        SFN_MARGIN_SWI = json_data_sfn[-1]['SFN_SWI']
                        ...
                        EM_KBR = json_data_sfn[-1]['EMMIS_KBR']
                        EM_PHT = json_data_sfn[-1]['EMMIS_PHT']
                        EM_SWI = json_data_sfn[-1]['EMMIS_SWI']
                        ...
                        PHT_load_ups = json_data_loadUps[-1]['loadPHT']
                        KPO_load_ups = json_data_loadUps[-1]['loadKPO']
                        KAI_load_ups = json_data_loadUps[-1]['loadKAI']
