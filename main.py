...
def selectFile():
        ...
        try:
                ...
                if (fileContent != ''):
                        ...
                        loadUps = requests.get("https://script.google.com/macros/s/AKfycbz-nIKZKu2WNPg0gd2IWqrbxwuZPNj_soFSzS0vriIOfiHJAVzQbPWuUkaIA2iGCkMHpg/exec")
                        print(loadUps.text)
                        ...
                        sheet["I36"] = ird_chp_lm_a
                        sheet["J36"] = ird_chp_cn_a
                        sheet["K36"] = ird_chp_lm_b
                        sheet["L36"] = ird_chp_cn_b
                        sheet["T36"] = ups_runtime_chp
                        sheet["Q36"] = chp_upper
                        sheet["O36"] = chp_lower
                        sheet["P36"] = chp_fwupper
                        sheet["N36"] = chp_fwlower
                        sheet["R36"] = chp_load_ups

                        

                        sheet["I37"] = ird_rng_lm_a
                        sheet["J37"] = ird_rng_cn_a
                        sheet["K37"] = ird_rng_lm_b
                        sheet["L37"] = ird_rng_cn_b
                        sheet["S37"] = ups_runtime_rng_h
                        sheet["T37"] = ups_runtime_rng_min
                        sheet["Q37"] = rng_upper
                        sheet["O37"] = rng_lower
                        sheet["P37"] = rng_fwupper
                        sheet["N37"] = rng_fwlower
                        sheet["R37"] = rng_load_ups


                        sheet["I42"] = ird_pkk_lm_a
                        sheet["J42"] = ird_pkk_cn_a
                        sheet["K42"] = ird_pkk_lm_b
                        sheet["L42"] = ird_pkk_cn_b
                        sheet["T42"] = ups_runtime_pkk
                        sheet["R42"] = pkk_load_ups

                        sheet["I43"] = ird_tas_lm_a
                        sheet["J43"] = ird_tas_cn_a
                        sheet["K43"] = ird_tas_lm_b
                        sheet["L43"] = ird_tas_cn_b
                        sheet["E43"] = sfn_tas
                        sheet["F43"] = em_tas

                        sheet["I44"] = ird_lhs_lm_a
                        sheet["J44"] = ird_lhs_cn_a
                        sheet["K44"] = ird_lhs_lm_b
                        sheet["L44"] = ird_lhs_cn_b
                        sheet["E44"] = sfn_lhs
                        sheet["F44"] = em_lhs

                        sheet["I38"] = ird_tsk_lm_a
                        sheet["J38"] = ird_tsk_cn_a
                        sheet["K38"] = ird_tsk_lm_b
                        sheet["L38"] = ird_tsk_cn_b
                        sheet["T38"] = ups_runtime_tsk
                        sheet["Q38"] = tsk_upper
                        sheet["O38"] = tsk_lower
                        sheet["P38"] = tsk_fwupper
                        sheet["N38"] = tsk_fwlower
                        sheet["R38"] = tsk_load_ups

                        sheet["I45"] = ird_pbi_lm_a
                        sheet["J45"] = ird_pbi_cn_a
                        sheet["K45"] = ird_pbi_lm_b
                        sheet["L45"] = ird_pbi_cn_b

                        sheet["I46"] = ird_hua_lm_a
                        sheet["J46"] = ird_hua_cn_a
                        sheet["K46"] = ird_hua_lm_b
                        sheet["L46"] = ird_hua_cn_b

                        sheet["I39"] = ird_pht_lm
                        sheet["J39"] = ird_pht_cn
                        sheet["T39"] = ups_runtime_pht
                        sheet["O39"] = pht_swrant
                        sheet["N39"] = pht_fwant

                        sheet["I40"] = ird_kpo_lm
                        sheet["J40"] = ird_kpo_cn
                        sheet["T40"] = ups_runtime_kpo
                        sheet["O40"] = kpo_swrant
                        sheet["N40"] = kpo_fwant
                        sheet["E40"] = sfn_kpo
                        sheet["F40"] = em_kpo

                        sheet["I41"] = ird_kura_lm
                        sheet["J41"] = ird_kura_cn
                        sheet["T41"] = ups_runtime_kura
                        sheet["O41"] = kai_swrant
                        sheet["N41"] = kai_fwant
                        sheet["E41"] = sfn_kai
                        sheet["F41"] = em_kai

                        sheet["I47"] = ird_swi_lm
                        sheet["J47"] = ird_swi_cn

                        sheet["I48"] = ird_pnp_lm
                        sheet["J48"] = ird_pnp_cn
                        sheet["E48"] = sfn_pnp
                        sheet["F48"] = em_pnp

                        sheet["I49"] = ird_kbr_lm
                        sheet["J49"] = ird_kbr_cn
